...
/************************ ADDITIONAL FEATURES ************************
     Plugins
*/
if (typeof(om_info.display_name) == "undefined") om_info.display_name = om_info.site;
var s_account="tmn-" + ((om_info.env == 'production') ? "prod" : "dev") + "-" + om_info.site + ", " + ((om_info.env == 'production') ? "ttrglobalproduction" : "tmn-dev-global");
...
function s_doPlugins(s) {
	...
	if (document.referrer.indexOf('http://www.google.com/url') == 0) {
		var organic = false;
		var position = false;
		var source = false;
