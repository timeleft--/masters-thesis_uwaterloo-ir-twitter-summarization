...
if(google_ads[0].type=="text"){s+='<div class="attribution wocc link-wox cnr5"><span class="tr"></span><span class="tl"></span>'+
google_attribution+'</div><div class="adsContainer cleared">';if(google_ads.length==1){title_span='<span class="title">';description_span='<span class="description">';url_style='style="color:#008000;font-size:14pt;text-decoration:none"> ';}
...
var wideAds="",narrowAds="";for(i=0;i<len;i++){if(google_ads[i].type=="text/wide"){wideAds+='<a style="text-decoration:none" onmouseover="javascript:window.status=\''+
google_ads[i].url+'\';return true;" '+'onmouseout="javascript:window.status=\'\';return true;" '+'href="'+google_ads[i].url+'">'+'<span class="ad_line1">'+google_ads[i].line1+'</span></a><br>'+'<span class="ad_text">'+google_ads[i].line2+'</span><br>'+'<a style="text-decoration:none" onmouseover="javascript:window.status=\''+
...
google_ads[i].line1+'</a><br>'+'<span class="ad_text">'+google_ads[i].line2+'</span><br>'+'<span class="ad_text">'+google_ads[i].line3+'</span><br>'+'<a class="ad_url" onmouseover="javascript:window.status=\''+
google_ads[i].url+'\';return true;" '+'onmouseout="javascript:window.status=\'\';return true;" '+'href="'+google_ads[i].url+'">'+
