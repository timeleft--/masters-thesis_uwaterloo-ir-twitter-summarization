...
This condition chooses closed itemsets which substantially violate the closed condition of their subsets. The proportion is a parameter, , that controls the selectivity of the \emph{distinctiveness} condition. Formally, the set of \emph{distinct} itemsets, $\mathcal{D}$, is defined as follows:
...
\rput(7.52,0.0){\includegraphics{/Users/yia/Code/thesis/write-ups/cikm/runtime_lcm-lcm+filter-fpzhu_seconds.eps}}
\usefont{T1}{ptm}{m}{n}
