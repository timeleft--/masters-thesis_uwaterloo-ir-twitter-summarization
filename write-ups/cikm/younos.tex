...
\caption{Effect of the maximum N-Gram length on the mining of a 1hr epoch of data}
\label{fig:ngramsLen}
\end{figure*}

After mining term N-Grams we flatten the itemsets to sets of unigrams again. This removes duplication caused by overlap
