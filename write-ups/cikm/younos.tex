...
\hline
\texttt{12:00} & breaking, news, head, coach, mike, brown, have, fired  \\\hline
\texttt{14:00} & cia, director, david, petraeus, resigns \\\hline
...
\multirow{2}{*}{\texttt{22:00}} & justin, bieber, and, selena, gomez, broke, up
\\ \cline{2-2}
& selamat, hari, pahlawan \\ \hline
\end{tabular}
\end{center}
\caption{November 9th from the top 3 itemsets}
 \label{table:nov9}
\end{table}
