...
Point-wise KL-Divergence & Strong Closed Itemsets & Itemsets Alliances \\
to, president (1), is, for, a, the, in, i, and, of, s, URL
\end{tabular}
\caption{Items present in filtered out itemsets but not in any itemset in the selection made by different criteria}
\label{table:filteringPerf}
\end{table*}
