...
Finally, there is a lot of redundancy in frequent itemsets caused by trivial differences in the language used.
 In this paper we propose methods for adapting Frequent Itemset Mining to be effective on social media text, without degrading its efficiency. %or relying on features of a particular language.
