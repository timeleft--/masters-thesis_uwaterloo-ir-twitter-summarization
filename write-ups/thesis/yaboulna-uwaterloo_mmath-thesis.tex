...
then producing a rule with each individual item as a precedent to the purchase of the rest of the itemset.
The Apriori algorithm finds frequent itemsets by finding itemsets of increasing lengthes iteratively.
