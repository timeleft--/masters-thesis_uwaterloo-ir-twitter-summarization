...
\hline
Time & Itemset & Explanation \\ \hline
\multirow{3}{*}{\texttt{13:00}} 	&  \em 0, 1, de, jong 			& De Jong scores for Ajax \\ \cline{2-3} %http://www.dailymail.co.uk/sport/football/article-2228815/Manchester-City-2-Ajax-2--match-report-Siem-Jong-Yaya-Toure-Sergio-Aguero-Champions-League.html
...
\multirow{3}{*}{\texttt{17:00}} 	& \em  if, obama, wins		& Speculations regarding elections \\ \cline{2-3}
						...
						& \em the, polls, close		& Polls to start closing at 6 PM \\\hline %http://www.huffingtonpost.com/2012/11/06/what-time-do-polls-close_n_2080894.html
...
\multirow{3}{*}{\texttt{22:30}} 	& \em once, you, go, black		& A popular cultural reference.\\ \cline{2-3} %  .. you never go back. 
						...
						%before the winner declares victory 
						\\\hline
...
\multirow{3}{*}{\texttt{23:00}} 	&\em  weed, is, legal, in, colorado		&  News that got a lot of attention regardless of the elections  \\ \cline{2-3}
						...
						& \em our, country, is, trouble		&   More dramatic reactions to elections from Donald Trump \\\hline						
...
\hline
Time & Itemset & \multicolumn{2}{c|}{Ranks} \\ %MTV & SC\\
%\hline
\hline
...
The quality of the results are comparable, but
...
We have shown that the top 3 \emph{strongly closed} itemsets 
from different hours are interesting, 
and that itemsets that are picked by the MTV algorithm are almost all 
...
given that documents are tokenized into variable length N-grams.
...
\subsection{The Complete Mining Results}
The complete results of mining all one hour epochs (with half hour time steps)
of Twitter data collected
in the last 3 months of 2012 is available for download\footnote{}. 
% at URL.
%The file includes the mining results at different values of $\kappa$,
