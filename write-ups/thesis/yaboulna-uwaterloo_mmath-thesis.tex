...
We have achieved improvements over a strong baseline
on the TREC 2011 microblog track queries, 
using frequent itemsets which are mined 
using an unmodified mining algorithm that 
...
where a different support threshold is used for different categories
of items according to their relative frequency.
