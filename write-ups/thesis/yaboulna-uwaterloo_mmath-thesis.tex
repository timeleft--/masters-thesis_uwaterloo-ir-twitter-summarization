...
because a \emph{distinct} itemset is always included in a \emph{strongly closed itemset} 
...
before taking the size of the difference decreases dramatically.
...
either by a superset or by an alternative that had enough confidence.
Below is a listing of the itemsets in the difference, 
along with the covering itemset from the selection 
for interesting itemsets (shown below it).
