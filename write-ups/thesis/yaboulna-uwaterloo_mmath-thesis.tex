...
Commonly used objective measures include:
\begin{enumerate}
\item \textbf{Support}: The fraction of transactions that contain the itemset
\item \textbf{Confidence}: The maximum confidence of a rule derived from the itemset. 
...
\item \textbf{Lift}: Probability (support) of the itemset over the product of the probabilities of all items in the itemset. This is a measure of dependence.
, coherence, and tf-idf for text patterns and attribute values for database tuples. 
Subjec- tive measure is usually a relative score compared with some prior knowledge or background model.
\end{enumerate}
