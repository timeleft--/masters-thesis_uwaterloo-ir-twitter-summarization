...
\begin{itemize}
\item Itemsets related to a certain topic will be mined close to each other.
...
either of the two branches. It should not belong to either of the clusters. % as we will see later.
\item 
...
than that of the topic's most discriminative itemset \{sham\}. %, and, travesty\}.
For example, the hierarchy $n1018 \rightarrow n1019 \rightarrow n1075$
has support values 120, 124, 126 respectively, 
which are all less than the support of n810 (142). %134 
...
Fans were voting for different artists to win the MTV Europe Music Awards (MTVEMA).
There are 4 distinct clusters in the figure; one for each artist, and one for
the itemsets not mentioning any artist.
