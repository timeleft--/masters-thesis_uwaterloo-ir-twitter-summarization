...
and \emph{distinct} itemsets ($\kappa = 0.25$). 
In the mining results of hour long epochs from the 
first two weeks of November 2012, 
the number of \emph{distinct} itemsets 
averages at 922.58 itemsets 
(37.8\% of closed itemsets of length 2 or more).
%the size of the difference is 1516.59 on average. closed itemsets of length 2 or more 2,439.17
