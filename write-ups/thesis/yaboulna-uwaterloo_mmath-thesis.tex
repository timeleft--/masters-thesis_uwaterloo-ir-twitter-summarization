...
However, the itemsets stored for each interval is not slected for providing the best summary.
...
First, the pyramidal time window is queried using a query (for example, ``world cup'') 
and a specific time intervals (before certain matches, for example).
