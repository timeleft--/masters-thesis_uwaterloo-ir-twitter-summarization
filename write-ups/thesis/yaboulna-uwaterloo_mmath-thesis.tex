...
$\alpha$ multiplied by the \emph{epoch}'s size: % volume velocity:
\begin{align}
support &= \alpha \times \frac{|E|}{E.span}  \hspace*{1in}  where\,\alpha: support\,ratio\\
&= \frac{minimum\_support\_threshold}{\textbf{avg}(\min_{day}{(vol.\, vel.)})} \times \frac{|E|}{E.span} 
\end{align}
