...
\begin{figure}
\scalebox{0.75}{
\includegraphics[trim=1in 0 0 0, clip=true]{clustering/elections-day_10pm-est_2.pdf}
}
...
the size of the difference is 1516.59 on average.
...
The difference becomes 3.1 itemsets on average
...
Below is a listing of the itemsets in the difference of that hour. 
