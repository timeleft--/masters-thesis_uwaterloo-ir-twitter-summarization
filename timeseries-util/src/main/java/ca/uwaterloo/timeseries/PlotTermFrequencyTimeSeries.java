...
public class PlotTermFrequencyTimeSeries {
	...
	public static RunMode runMode = RunMode.RRD4J;
	private static long windowLength = 3600000;
	private static String ixPath = "/Users/yia/indexes/tweets_trec2011-17hrs_1hr-chunks";
	private static String outParent = "/Users/yia/tweet_plots/";
			...
			for (File endDir : endArr) {
				...
				if (endTime - startTime >= windowLength) {
					...
					while (startTime < endTime) {
						...
						List<String> tList = Lists.newLinkedList();
