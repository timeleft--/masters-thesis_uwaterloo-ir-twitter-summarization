...
ngram1C2S0 = FOREACH ngram1X2S0 GENERATE (ngram1P0::ngram, ngram1P1::ngram) as token, ngram1P0::date as date, ngram1P0::id as id, ngram1P0::pos as pos, ngram1P0::timeMillis as timeMillis, (ngram1P0::len + ngram1P1::len) as len;
