...
ngram1C2S14 = FOREACH ngram1X2S14 GENERATE ngram1P14::id, ngram1P14::timeMillis, ngram1P14::date, (ngram1P14::ngram, ngram1P15::ngram)  as ngram, 2 as ngramLen, ngram1P14::tweetLen,  ngram1P14::pos; 

ngram2 = UNION ngram1C2S0, ngram1C2S1, ngram1C2S2, ngram1C2S3, ngram1C2S4, ngram1C2S5, ngram1C2S6,
	ngram1C2S7, ngram1C2S8, ngram1C2S9, ngram1C2S10, ngram1C2S11, ngram1C2S12, ngram1C2S13, ngram1C2S14;
