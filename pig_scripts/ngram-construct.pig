...
tweets = LOAD 'file:///home/yaboulna/vmshared/spritzer_2012-09-14_2013-01-11_csv/[^_.]*7' USING PigStorage('\t') AS (id:long, screenname:chararray, timestamp:long, tweet:chararray); 
