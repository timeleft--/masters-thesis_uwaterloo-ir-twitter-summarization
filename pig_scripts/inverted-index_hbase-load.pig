...
unigramsStruct1 = LOAD 'hbase://tokenPos' USING yaboulna.pig.HBaseStorage('d:21221', '-versions 1000 -eq the') AS (token: chararray, days: {(day: chararray, vers: {(id: long, pos:bytearray)})});
