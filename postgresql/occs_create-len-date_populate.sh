...
#echo "${psql} 'CREATE TABLE occurrences(compgram text[], id int8, timemillis int8, date int4,  compgramlen int2, tweetlen int2, pos int2, yuleq float8, epochcnt int8, dunningl float8);'" 
