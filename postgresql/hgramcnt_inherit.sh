...
#echo "${psql} \"CREATE INDEX hgram_cnt_${epoch}${len}_${day}_date ON hgram_cnt_${epoch}${len}_${day}(date); 
echo "${psql} \"CREATE INDEX hgram_cnt_${epoch}${len}_${day}_ngramlen ON hgram_cnt_${epoch}${len}_${day}(ngramlen);\"&"    
done
